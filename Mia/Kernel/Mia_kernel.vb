...
Public Class Mia_kernel
    ...
    Dim ControllerBrain As New Controller(TimeOfDay.ToString("h:mm:ss tt")) 'Processa comandos do usuário
    Dim Action As New ProcessAction 'Toda a parte de ação que responde a usuário
    ...
    Sub Init1() 'Starta o processamento
        ...
        ControllerBrain.ReceiveQuestions(TheMemory.ReadQuestion)
    ...
    Function RequestWarnings(WarningCode As Integer) As String
        If (WarningCode > 0) Then
            'reorna uma aviso
            Return ControllerBrain.RequestWarnings(WarningCode)
        Else
            Return "Erro"
        End If
    ...
    Function RequestQuestion() As String
        ...
        Return ControllerBrain.RequestQuestion()
    End Function
    ...
    Function RequestWeather() As String
        ...
        If (response.Contains("Vazio")) Then
            Debug.Print("erro ao peggar a temperatura.")
            Return "Erro"
        Else
...
#Disable Warning
        ...
        Catch ex As Exception
            Return 3 'erro
            Main.Throwalert(ex.Message)
            Debug.Print("Erro " + ex.StackTrace)
        Finally
...
#Enable Warning
    ...
    Function RequestGamelist() As List(Of GameListSchedule)
        'Retorna array com lista de games
        Return TheMemory.ReadGameList()
    End Function
