    ...
    Function GetWeather() As String
        ...
        Try
            Using wc As New WebClient
                ...
                Return CelsiusValue.ToString + "," + weatherObject.query.results.channel.item.condition.text.Replace("Mostly Cloudy", "Maioritariamente  nublado").Replace("Partly Cloudy", "Parcialmente nublado").Replace("Cloudy", "Nublado")
